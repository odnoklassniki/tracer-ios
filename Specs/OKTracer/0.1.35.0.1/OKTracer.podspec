Pod::Spec.new do |s|
    ...
    s.source                = { :http => 'https://artifactory-external.vkpartner.ru/artifactory/okdl-ios-tracer-cache/OKTracer/0.1.35.0.1/OKTracer.xcframework.zip' }
